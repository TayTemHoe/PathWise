...
import '../widgets/big_five/big_five_navigation_widget.dart';
import '../widgets/big_five/big_five_progress_indicator.dart';
import '../widgets/big_five/big_five_question_card.dart';
import 'big_five_result_screen.dart';

class BigFiveTestScreen extends StatefulWidget {
  const BigFiveTestScreen({Key? key}) : super(key: key);
...
class _BigFiveTestScreenState extends State<BigFiveTestScreen> {
  late final BigFiveTestViewModel _viewModel;
    ...
    return ChangeNotifierProvider.value(
      ...
      child: WillPopScope(
        ...
        child: Scaffold(
          ...
          appBar: _buildAppBar(),
          body: Consumer<BigFiveTestViewModel>(
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          Text(
            'Preparing 120 questions for you',
            style: TextStyle(
              fontSize: 14,
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            "Calculating your Big Five traits...",
            style: TextStyle(
              fontSize: 14,
              color: AppColors.textSecondary,
            ),
  ...
  Widget _buildErrorState(BigFiveTestViewModel viewModel) {
    return Center(
      child: Padding(
        padding: const EdgeInsets.all(24),
        child: Column(
  ...
  Future<void> _showRestartConfirmation(BigFiveTestViewModel viewModel) {
    return showDialog(
      context: context,
      builder: (context) => AlertDialog(
        shape: RoundedRectangleBorder(
